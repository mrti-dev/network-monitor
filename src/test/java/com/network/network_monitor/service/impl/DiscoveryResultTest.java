...
class DiscoveryResultTest {
    ...
    void callerCatchesFailureThrownByTransactionProxyAtCommit() {
        ...
        var result = new DiscoveryServiceImpl(proxy, new MonitoringDefaults()).persistDiscoveredDevices(
    ...
    void commitFailureDoesNotStopLaterIpsAndOnlyInsertIsNew() {
        ...
        var response = new DiscoveryServiceImpl(transaction, new MonitoringDefaults()).persistDiscoveredDevices(devices, "subnet");
